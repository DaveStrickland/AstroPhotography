...
def command_line_opts(argv):
    ...
    parser.add_argument(
        ...
        help=(
            "Path/name of the FITS image to added metadata to."
    ...
    parser.add_argument(
        ...
        default=p_mode,
        help=(
            'Mode of operation. If "iTelescope" the telescope, target,'
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "A target name to be used for name resolution in cases"
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            'If "mode==yamlkeyval" then this parameter must be the'
