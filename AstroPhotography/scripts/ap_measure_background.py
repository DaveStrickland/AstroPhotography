...
def command_line_opts(argv):
    ...
    parser = argparse.ArgumentParser(
        prog="ap_measure_background",
        description=(
            "Measures and outputs large scale non-uniform sky"
    ...
    parser.add_argument(
        ...
        help=(
            "Path/name of the output estimate of the large scale background."
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional source list to use to exclude stars when generating"
    ...
    parser.add_argument(
        ...
        default=p_nbg_cols,
        help=(
            "Number of regions to split the image into width-wise"
    ...
    parser.add_argument(
        ...
        default=p_nbg_rows,
        help=(
            "Number of regions to split the image into height-wise"
            " to assess the local background in."
    ...
    parser.add_argument(
        ...
        help=(
            "Minimum width in pixels of a background region."
    ...
    parser.add_argument(
        ...
        help=(
            "Minimum height in pixels of a background region."
    ...
    parser.add_argument(
        ...
        help=(
            "Photutils Background2D filter size"
    ...
    parser.add_argument(
        ...
        help=(
            "Photutils Background2D exclude_percentile"
    ...
    parser.add_argument(
        ...
        help=(
            "Photutils Background2D sigma_clip parameter,"
