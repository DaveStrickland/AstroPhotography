...
def command_line_opts(argv):
    ...
    parser = argparse.ArgumentParser(
        prog="ap_imarith",
        description=(
            "Perform arithmetic operations on a FITS file,"
    ...
    parser.add_argument(
        ...
        metavar="OPERATION",
        help=(
            "The mathematical operation to perform, represented as"
    ...
    parser.add_argument(
        ...
        help=(
            "A floating point value OR the path to another fits image"
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            'String specifying the output image units, e.g. "adu/s".'
...
def main(args=None):
    ...
    imarith.process_files(p_inp_img, p_operation, p_value, p_out_img, p_units)
