...
def command_line_opts(argv):
    ...
    parser = argparse.ArgumentParser(
        prog="ap_calibrate",
        description=(
            "Performs calibration of raw astronomical images"
    ...
    parser.add_argument(
        "master_bias", metavar="MBIAS.FITS", help="Path/name of the master bias file."
    )
    parser.add_argument(
        "master_dark",
        metavar="MDARK.FITS",
        help=(
            "Path/name of the master dark file."
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Path/name of the master flat file."
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "Half-width and half-height of the box surrounding a bad"
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "If specified, cosmic ray removal will be performed."
...
def main(args=None):
    ...
    calibrator = ap.ApCalibrate(
        p_mbias, p_mdark, p_mflat, p_mbadpix, p_loglevel, p_dark_still_biased
    )

    # Tell it to calibrate data from files (rather than numpy arrays).
    calibrator.calibrate(p_raw_img, p_out_img, p_deltapix, p_normflat, p_fixcosmic)
