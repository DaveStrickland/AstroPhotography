...
# -*- coding: utf-8 -*-
#
#  Contains the implmentation of ApMasterCal
#
...
class ApMasterCal:
    ...
    temptol : float, optional, default=0.5
        Allowable temperature tolerance up to which the CCDTEMP
    ...
    def __init__(
        ...
        """
        self._name = "ApMasterCal"  # str : class name
    ...
    def _check_files(self, list_all: bool | None = None):
        ...
        Parameters
        ----------
        list_all : bool or None, optional, default=None
        ...
        if nuniq == 1:
            ...
            if not isinstance(val, float):
                msg = (
                    "No files contain CCD-TEMP metadata. Continuing"
    ...
    def _create_file_collection(
        ...
        file_collection = ccdp.ImageFileCollection(
            data_dir, keywords=self._summary_kw, glob_exclude=exclude_pattern, filenames=file_list
        )
    ...
    def make_master(self, output_master_file):
        ...
        output_master_file : str
            Name for the master calibration file to create. Any existing
            file of that name will be over-written.
        """
        ...
        with warnings.catch_warnings():
            ...
            master.unit = "adu"
            # Remove...
            kw_to_remove_list = ["UT", "TIME-OBS", "SWOWNER", "SWCREATE", "SBSTDVER"]
            ...
            # Write file
            master.write(output_master_file, overwrite=True, output_verify="ignore")
