...
Report bugs at https://github.com/DaveStrickland/astrophotography/issues.
...
Ready to contribute? Here's how to set up `astrophotography` for local development.
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.com/DaveStrickland/astrophotography/pull_requests
...
$ pytest tests.test_astrophotography
